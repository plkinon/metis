...
%[simulation, system, integrator, solver] = Metis('input/single_analysis_pendulumMinCoord', 1, 1);
[simulation, system, integrator, solver] = Metis('input/single_analysis_SpringPendulum', 1, 1);
%% METIS solver
