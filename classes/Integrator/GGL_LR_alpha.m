classdef GGL_LR_alpha < Integrator
    ...
    methods
        ...
        function self = GGL_LR_alpha(this_simulation, this_system)
        ...
        function [resi, tang] = compute_resi_tang(self, zn1, zn, this_system)
            ...
            %% Residual vector
            resi = [(qn1 - qn - (1 - al) * h * IM * pn1 + (1 - al) * (h^2) / 2 * IM * G_n1' * gamma_n1 - al * h * IM * pn + al * (h^2) / 2 * IM * G_n' * lambdan); (pn1 - pn + h * DV_nal - h / 2 * G_n1' * gamma_n1 + h / 2 * G_n' * lambdan); g_n1; G_n1 * IM * pn1];
