classdef GGL_VI < Integrator
    ...
    methods
        ...
        function self = GGL_VI(this_simulation, this_system)
        ...
        function [resi, tang] = compute_resi_tang(self, zn1, zn, this_system)
            ...
            %% Residual vector
            resi = [qn1 - qn - h * IM * pn1 - h * IM * G_n1' * gamman1; pn1 - pn + h * DV_n + h * G_n' * lambdan + h * t_n * IM * pn; g_n1; G_n1 * IM * pn1];

            %% Tangent matrix
            tang = [eye(n) - h * IM * t_n1, -h * IM, zeros(n, m), -h * IM * G_n1'; zeros(n), eye(n), h * G_n', zeros(n, m); G_n1, zeros(n, m)', zeros(m), zeros(m); T_n1, G_n1 * IM, zeros(m), zeros(m)];
