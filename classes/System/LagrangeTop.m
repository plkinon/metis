...
classdef LagrangeTop < System
    ...
    methods
        ...
        function self = LagrangeTop(CONFIG)
            ...
            % Principle moments of inertia w.r.t d_i-system
            ...
            J_tilde = diag([I1,I2,I3]);
            J_tilde_inv = J_tilde \ eye(3);
                                                                            ...
                                                                            function D2zetaDq2 = constraint_invariant_hessian(~, ~, i)
                                                                                ...
                                                                                function gs = constraint_from_invariant(~, zeta, i)
                                                                                    ...
                                                                                    function analyzed_quantity = hconvergence_set(self, this_simulation)
                                                                                        ...
                                                                                        function reference_solution = hconvergence_reference(self, this_simulation, analyzed_quantity)

                                                                                            if strcmp(this_simulation.CONV_QUANTITY,'q')    
                                                                                                reference_solution = this_simulation.Q_0(3)*self.GEOM(4); %position
