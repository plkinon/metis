classdef SpringPendulumLinear < System
    ...
    methods
        ...
        function self = SpringPendulumLinear(CONFIG)
        ...
        function V_int = internal_potential_from_mixed_quantity(self, epsilon)
        ...
        function DV_int = internal_potential_gradient_from_mixed_quantity(self, epsilon)
            k = self.GEOM(2);

            DV_int = k*epsilon ;
        end

        function D2V_int = internal_potential_hessian_from_mixed_quantity(self, ~)
            k = self.GEOM(2);
            D2V_int = k ;
        end
