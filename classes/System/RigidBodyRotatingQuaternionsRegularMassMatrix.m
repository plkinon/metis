...
classdef RigidBodyRotatingQuaternionsRegularMassMatrix < System
    ...
    methods
        ...
        function self = RigidBodyRotatingQuaternionsRegularMassMatrix(CONFIG)
        ...
        % kinetic energy computed with the invariant based on v
