...
[dummy_simulation, system, dummy_integrator, solver] = Metis('input/error_analysis_SpringPendulumLinear', 1, 1);
...
for i = 1:n_DT
    for j = 1:n_INT
        ...
        [current_simulation, ~, current_integrator, ~] = Metis('input/error_analysis_SpringPendulumLinear', i, j);
