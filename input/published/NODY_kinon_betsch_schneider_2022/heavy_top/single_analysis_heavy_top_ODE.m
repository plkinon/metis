...
R0 = [1, 0, 0; 0, cos(alpha0), -sin(alpha0); 0, +sin(alpha0), cos(alpha0)];
...
clear rho a r l d I1 I2 I3 J_tilde m_0 J J1 J3 alpha0 R0 phi0 d10 d20 d30 OMEGA0 v00 v10 v20 v30 omega_p omega_s g
...
%% Postprocessing
shouldAnimate = false;
plot_quantities = {'energy', 'energy_difference', 'angular_momentum', 'angular_momentum_difference'};
should_export = true;
